    ...
    return (
        <div className=" text-slate-50 bg-orange-blue py-5">
            <div className="px-4 flex justify-between">
                ...
                < nav className="absolute mx-auto w-11/12 inset-x-0 top-24 md:top-0 md:inset-0 md:block md:mx-0 md:w-auto bg-slate-50 md:bg-transparent text-black md:relative bubble" aria-label="primary navigation ">
                    <ul className="text-center flex flex-col px-20 py-10 md:px-0 md:py-0 md:flex-row md:space-x-5">
